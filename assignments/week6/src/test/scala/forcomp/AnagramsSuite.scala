...
class AnagramsSuite extends FunSuite {
  ...
  test("sentenceOccurrences: abcd <emptystring> e") {
  ...
  test("sentenceOccurrences: abcd ea ba") {
    assert(sentenceOccurrences(List("abcd", "ea", "ba")) === List(('a', 3), ('b', 2), ('c', 1), ('d', 1), ('e', 1)))
  }
  ...
  test("subtract: barry - bar") {
    val barry = List(('a', 1), ('b', 1), ('r', 2), ('y', 1))
    val bar = List(('a', 1), ('b', 1), ('r', 1))
    val ry = List(('r', 1), ('y', 1))
    assert(subtract(barry, bar) === ry)
  }
  
  test("subtract: barry - Nil") {
    val barry = List(('a', 1), ('b', 1), ('r', 2), ('y', 1))
    assert(subtract(barry, Nil) === barry)
  }
